// src/components/cards/VPNAPICard.tsx
...
import type { VPNAPIData } from "@/types/threat";

export function VPNAPICard({ data }: { data: VPNAPIData }) {
  ...
  return (
    <div className="bg-card border-l-2 border-teal-500/60">
      <style>
        {`
      ...
      >
        <div className="flex items-center gap-1.5">
          <Globe className="h-3 w-3 text-teal-500/70" />
        ...
        <div className="px-3 py-2 flex items-center justify-between text-[9px]">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={(e) => {
                e.stopPropagation();
                window.open(`https://vpnapi.io/`, "_blank");
              }}
              className="text-teal-500/70 hover:text-teal-500 flex items-center gap-0.5"
            >
      ...
      {expanded && (
        <div className="p-3">
          ...
          {/* Security Indicators Grid - 4 columns for VPN, Proxy, TOR, Relay */}
          ...
          {/* View Report Button */}
          <button
            onClick={() => window.open(`https://vpnapi.io/`, "_blank")}
            className="w-full mt-3 py-1.5 bg-teal-500/10 border border-teal-500/30 text-teal-500 text-[10px] font-medium hover:bg-teal-500/20 transition-colors flex items-center justify-center gap-1"
          >
