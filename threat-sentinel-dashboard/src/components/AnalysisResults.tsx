...
export function AnalysisResults({ data }: { data: ThreatData }) {
  const availableCards = [
    ...
    {
      id: "abuseipdb",
      condition: data.abuseipdb && Object.keys(data.abuseipdb).length > 0,
      component: <AbuseIPDBCard data={data.abuseipdb!} />,
    },
    {
      id: "otx",
      condition: data.otx && Object.keys(data.otx).length > 0,
      component: <OTXCard data={data.otx!} />,
    },
    {
      id: "greynoise",
      condition: data.greynoise && Object.keys(data.greynoise).length > 0,
    ...
    {
      id: "censys",
      condition: data.censys && data.censys.services,
  ...
  return (
    ...
    >
      ...
      {/* Intelligence Cards Grid - Tight spacing */}
